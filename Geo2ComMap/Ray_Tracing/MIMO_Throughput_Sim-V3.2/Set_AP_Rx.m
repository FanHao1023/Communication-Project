% load('Rx_Sample_9F');                % Rx Location in Wireless Insite 
%load("Building1_37\position.mat")
...
%% AP
Tx_power_dB = 50;                      % (dB) Tx amplified ratio to 0 dBm (Assume Tx power in WirelessInsite is 0 dBm)
